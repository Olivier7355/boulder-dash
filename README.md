...
This is just a programming experiment of the Boulderdash game mechanics. Therefore it does not include all the features from the [orginal Boulder Dash version (1984)](https://en.wikipedia.org/wiki/Boulder_Dash) from Peter Liepa.
